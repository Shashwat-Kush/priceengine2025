    ...
    sku_rows = [
        {
            ...
            "image_url": "https://rukminim2.flixcart.com/image/480/640/xif0q/mobile/h/h/z/-original-imaghkvufhjsnw7q.jpeg",
        },
        {
            "base_id": "sku-002",
            ...
            "description": "Reliable Samsung phone with large battery and smooth UI.",
            "features": {
                "Display": "6.6\" PLS LCD",
                "Battery": "6000 mAh",
                "Camera": "50MP main",
            ...
            "image_url": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTEvGF7ZbMxLM2QXSKHtyE4JkFRGSiePmzMQA&s",
        },
        {
            "base_id": "sku-003",
            "name": "iQOO Z8",
            ...
            "price_sensitivity": "high",
            "festival_sensitivity": "high",
            "description": "Gaming-capable phone with fast charging and high refresh display.",
            "features": {
                "Display": "6.67\" 120Hz",
                "Battery": "6000 mAh",
                "Camera": "64MP main",
            ...
            "image_url": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRqxMib20KBlaHL-m1A7sW1LU9AaLnPqV-Cqw&s",
        },
        {
            "base_id": "sku-004",
            ...
            "price_sensitivity": "medium",
            "festival_sensitivity": "medium",
            "description": "Premium-feel mid-range phone with OxygenOS and smooth performance.",
            "features": {
                "Display": "6.7\" AMOLED",
                "Battery": "5000 mAh",
                "Camera": "50MP main",
            ...
            "image_url": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRW7QdSR5nQasxfrIHM-xFM31Di8oEz3QooZA&s",
        },
        {
            "base_id": "sku-005",
            ...
            "price_sensitivity": "high",
            "festival_sensitivity": "high",
            "description": "Value-focused phone with good cameras and gaming chops.",
            "features": {
                "Display": "6.72\" 120Hz",
                "Battery": "5000 mAh",
                "Camera": "108MP main",
            ...
            "image_url": "https://rukminim2.flixcart.com/image/480/640/xif0q/mobile/b/1/u/narzo-70-pro-5g-rmx3868-realme-original-imah3fxdwmnpnbxv.jpeg",
        },
    ]
        ...
        skus.append(
            {
                ...
                "launch_date": now.date().isoformat(),
                "created_at": now,
                "updated_at": now,
            }
        )
        ...
        listings.append(
            {
                ...
                "service_level": 0.95,
                "logistics_cost_per_order": 150.0,
                "min_margin_pct": 5.0,
                "created_at": now,
                "updated_at": now,
            }
